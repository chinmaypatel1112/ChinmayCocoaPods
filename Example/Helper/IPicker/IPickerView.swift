...
//        } else {
            self.constraintTop(to: parent.topAnchor, constant: 0)
                       self.constraintBottom(to: parent.bottomAnchor, constant: 0)
                       self.constraintLeading(to: parent.leadingAnchor, constant: 0)
                       self.constraintTrailing(to: parent.trailingAnchor, constant: 0)
...
//        }else{
            upperView.constraintTop(to: topAnchor, constant: 0)
            upperView.constraintLeading(to: leadingAnchor, constant: 0)
            upperView.constraintTrailing(to: trailingAnchor, constant: 0)
       // }
...
//        }else{
            pickerContainerView.constraintBottom(to: doneBottomView.topAnchor, constant: -8)
            pickerContainerView.constraintLeading(to: self.leadingAnchor, constant: 12)
            pickerContainerView.constraintTrailing(to: self.trailingAnchor, constant: -12)
        //}
...
//        }else{
            doneBottomView.constraintBottom(to: self.bottomAnchor, constant: -8)
                  doneBottomView.constraintLeading(to: self.leadingAnchor, constant: 12)
                  doneBottomView.constraintTrailing(to: self.trailingAnchor, constant: -12)
       // }
